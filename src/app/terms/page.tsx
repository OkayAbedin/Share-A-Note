        ...
        <div className="glass rounded-lg border border-zinc-800/50 p-8">
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-zinc-100 mb-4">Service Description</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-zinc-100 mb-4">User Responsibilities</h2>
              <p className="text-zinc-300 mb-4">When using Share-A-Note, you agree to:</p>
              <ul className="list-disc pl-6 text-zinc-300 space-y-2">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-zinc-100 mb-4">Content and Data</h2>
              <ul className="list-disc pl-6 text-zinc-300 space-y-2">
                <li>You retain ownership of content you create</li>                <li>Notes are automatically deleted after 30 days of inactivity</li>
